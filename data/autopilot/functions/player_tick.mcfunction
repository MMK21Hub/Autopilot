...
execute if predicate autopilot:in_flight if score @s velocityY <= $velocityThreshold autopilot if predicate autopilot:near_ground run function autopilot:pull_up